						...
						<div class="col-md-3">
							...
							<section class="panel">
								<header class="panel-heading">
									...
									<button type="button" class="btn-9" id="open-session"><i class="fa fa-volume-up"></i></button> Audio /
						...
						<div class="col-md-6 " >
							...
							<div class="col-md-12 bnt-grp-4">
								...
								<?php if($_SESSION['user_status'] == 'dosen'):?>
									<li><button type="button" class="btn-4" id="openRoom" >Create Room</button><button type="button" class="btn-4" id="openRoom" style="display:none">Create Room</button></li>
								<?php else:?>
									<li><button type="button" class="btn-4" id="openRoom" style="display:none">Create Room</button><button type="button" class="btn-4" id="joinRoom" >Join Room</button></li>
								<?php endif;?>
